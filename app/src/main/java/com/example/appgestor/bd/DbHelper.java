...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
       ...
       // db.execSQL("INSERT INTO "+TABLE_USERS+" VALUES('Carlos Baltodano','carlos@gmail.com','beto','123456');");

    //    db.execSQL("INSERT INTO "+TABLE_PDV+" VALUES('409183','YOSLI AMALI SEGUILAR','REAL S/N Urb: ESQ.10 NOVIEMBRE');");
     //   db.execSQL("INSERT INTO "+TABLE_PDV+" VALUES('409184','METRO ALFONSO UGARTE','AV.ALFONSO UGARTE 740');");
   //    db.execSQL("INSERT INTO "+TABLE_PDV+" VALUES('409185','TOTTUS ZORRITOS','AV.COLONIAL 1520');");
    //    db.execSQL("INSERT INTO "+TABLE_PDV+" VALUES('409186','MEGAPLAZA LIMA NORTE','AV.INDEPENDENCIA 3150');");
